...
public class Matrice {
	...
	public void creerMatrice() {
		...
		int dimension = this.demanderDimension();
		this.matrice = new double[dimension][dimension];
	...
	public String toString() {
		StringBuilder matriceVisuelle = new StringBuilder();

		for (int i = 0; i < this.getDimension(); i++) {
			matriceVisuelle.append("|\t");
			matriceVisuelle.append(String.valueOf(this.matrice[i][0]));
			for (int j = 1; j < this.getDimension(); j++) {
				matriceVisuelle.append("\t");
				matriceVisuelle.append(String.valueOf(this.matrice[i][j]));
			}
			matriceVisuelle.append("\t|\n");
		}

		return matriceVisuelle.toString();
	}
}
//	private double[][] matrice;
